...
export const SPOTS: HyogoSpot[] = [
  ...
  { id: "harborland", name: "神戸ハーバーランド umie", genre: "ショッピング", area: "神戸", city: "神戸市中央区", description: "海沿いの大型モール。観覧車やグルメも充実。", access: "神戸本店から車で約9分", relatedStoreId: "kobe-honten", tags: ["モール", "海沿い", "家族"], photo: "/spots/umie.jpg" },

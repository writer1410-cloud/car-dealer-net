...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    area: "神戸",
    excerpt:
      "1世帯あたりのパン購入額が全国トップクラスの神戸。港の開港とともに150年以上前から根づいたパン文化を体現する、実在の名店3軒を編集部が厳選しました。",
    date: "2026-06-26",
    tags: ["パン屋", "神戸", "フロインドリーブ", "イスズベーカリー", "トミーズ"],
    relatedStoreId: "kobe-honten",
    featured: true,
    photo: "/spots/kobe-bakery.jpg",
    sections: [
      {
        heading: "フロインドリーブ｜教会を改装した、創業100年の老舗（中央区）",
        body: "1924年に初代ハインリッヒ・フロインドリーブが開いたドイツ系ベーカリー。夫妻の奮闘はNHK連続テレビ小説「風見鶏」のモデルにもなりました。中央区生田町の本店は、登録有形文化財の旧教会をリノベーションした開放感あふれる空間。看板は外はパリッ、中はふんわりの山型「ハードトースト」。隣接工場で朝に焼き上がる食パンを使ったサンドイッチも評判です。",
      },
      {
        heading: "イスズベーカリー｜名物トレロンで知られる戦後の老舗（三宮）",
        body: "1946年創業、70年以上にわたり地元で愛され続ける老舗。名物「トレロン」は、粗挽きソーセージと粒マスタードをフランスパン生地で包んで焼いた長さ約70cmのインパクト抜群の一本。山型食パンなど毎日の定番も充実し、三宮を中心に神戸の食卓を支えています。",
      },
      {
        heading: "トミーズ｜“あん食”で全国区、東灘の人気店（東灘区）",
        body: "1977年創業、神戸市内に4店舗を展開。看板商品の「あん食」は、北海道産小豆の粒あんと生クリームを織り込んだ食パンで、1日約1000本を売り上げる大ヒット。工場併設の魚崎本店は朝7時から営業し、焼きたてを求めて多くのファンが足を運びます。",
      },
      {
        heading: "電動自転車「ぐるっとバイク」でベーカリーめぐり",
        body: "坂の多い神戸の街も、店舗で貸し出す電動アシスト自転車「ぐるっとバイク」ならスイスイ。点検・車検を待つあいだに、港町・神戸が育んだ名店のパンを食べ比べてみては。※営業時間・定休日は変わることがあります。お出かけ前に各店の最新情報をご確認ください。",
      },
    ],
  },
  {

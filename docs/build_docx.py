...
add_table(
    ...
    [
        ...
        ["4", "入庫スケジュール可視化", "管理者", "全店舗×日付の稼働をAM/PMヒートマップで把握"],
        ["5", "スタッフ店舗間配置", "管理者", "所属店舗を越えた応援シフトの管理とAI提案"],
        ["6", "AI最適化アシスタント", "管理者", "午後誘導・店舗振り分け・応援配置を重要度つきで自動提案"],
    ],
    widths=[1, 5, 2.5, 8],
)
...
add_table(
    ...
    [
        ...
        ["/stores/[id]", "店舗詳細", "フォトヒーロー、周辺スポット、直近の空き状況、スタッフ体制"],
    ],
    widths=[4, 4, 8],
)
